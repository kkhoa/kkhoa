...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
	...
	if (event.body.indexOf("bot đâu rồi")==0 || (event.body.indexOf("Bot đâu rồi")==0) || (event.body.indexOf("bot đâu")==0) || (event.body.indexOf("đĩ bot đâu rồi")==0)) {
		var msg = {
				body: "kêu gì con đĩ t vừa off đi ỉa có tí đã kêu! chuyện buồn hay cần lời khuyên thì đã có bot đây yên tâm trừ khi pay acc chứ lúc nào bot cũng ở bên nhó  ",
			}
