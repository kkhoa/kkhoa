 ...
 switch(event.body){
  case "1":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/ti.jpg`)
  ...
  case "2":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/suu.jpg`)
   }, event.threadID, event.messageID);
   break;
  case "3":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/dan.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "4":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/mao.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "5":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/thin.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "6":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/ty.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "7":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/ngo.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "8":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/mui.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "9":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/than.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "10":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/dau.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "11":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/tuat.jpg`)
   }, event.threadID, event.messageID); 
   break;
  case "12":
   api.sendMessage({
    ...
    attachment: fs.createReadStream(__dirname + `/cache/hoi.jpg`)
   }, event.threadID, event.messageID); 
   break;
  default:
 }
...
module.exports.handleEvent = function({ api, event}) {
 if (event.body.indexOf("12 con giáp")==0 || (event.body.indexOf("12 con giáp")==0)) {
  api.sendMessage({
   body: "☯12 Con Giáp Dân Gian☯ \n\n 1. Tý 🐁\n 2. Sửu 🐃\n 3. Dần 🐅\n 4. Mão 🐈\n 5. Thìn 🐉\n 6. Tỵ 🐍\n 7. Ngọ 🦓\n 8. Mùi 🐐\n 9. Thân 🐒\n10. Dậu 🐓\n11. Tuất 🐕\n12. Hợi 🐖\n\nReply tin nhắn theo số để xem chi tiết hơn về từng con giáp ! ",
