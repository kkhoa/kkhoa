...
const fs = global.nodemodule["fs-extra"];
 ...
 "https://i.imgur.com/vrVWU0V.jpg",
  ...
  var callback = () => api.sendMessage({body:`Cặp loa mlem 😋\nSố loa đài hiện có trên web: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
